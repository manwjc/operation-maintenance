  ...
  <div class="component-container1">
        ...
        <el-row class="con">
          ...
          <el-col :span="8" class="content">
            ...
            <el-form-item class="item-name"
                          ...
                          :rules="[{required: true, message: '请选择关联对象', trigger: 'change'}]"
              ...
              <el-select
                ...
                @change="bizChange()">
                <el-option v-for="item in bizSysList" :key="item.value" :label="item.name"
        ...
        <el-row class="con1">
          <el-col :span="24" class="content">
            ...
            <el-form-item class="item-name"
              ...
              <el-input v-show="themeBut" id="name" :maxlength="100" v-model.trim="theme_code1"
                        class="butInp"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </div>
        ...
        <el-row class="con1">
          <el-table
            ...
            <el-table-column
              ...
              align="center">
              <template slot-scope="scope">
                <el-input v-model.trim="form.dim_list[scope.$index].dim_reg" class=""
                          v-if="form.dim_list[scope.$index].match_flag === '2'"></el-input>
                <el-select
                  class="select"
                  filterable
                  placeholder="请选择"
                  v-model.trim="form.dim_list[scope.$index].dim_reg" v-else
                  :disabled="form.dim_list[scope.$index].match_flag !== '1'"
            ...
            <el-table-column
              ...
              align="center">
              <template slot-scope="scope">
                <el-input v-model.trim="form.dim_list[scope.$index].dim_code"
                          :disabled="form.dim_list[scope.$index].match_flag !== '1'"
                          :title="form.dim_list[scope.$index].dim_code" class="itemCode"></el-input>
              </template>
            </el-table-column>
            <el-table-column
              prop="dim_name"
              ...
              align="center">
              <template slot-scope="scope">
                <el-input v-model.trim="form.dim_list[scope.$index].dim_name"
                          :disabled="form.dim_list[scope.$index].match_flag !== '1'"
                          :title="form.dim_list[scope.$index].dim_name" class="itemCode"></el-input>
              </template>
            </el-table-column>
            <el-table-column
              prop="dim_type"
              ...
              <template slot-scope="scope">
                <el-select
                  ...
                  <el-option v-for="item in dimOptions" :key="item.value" :label="item.label"
                             :value="item.value"></el-option>
                </el-select>
              </template>
            </el-table-column>
        ...
        <div class="con" v-show="showTest">
          <el-row style="margin-top:40px;display: flex;" class="con1">
            <el-col :span="5" class="head-left">
              <img style="float: left;width: 40px;height: 40px;margin-right:5px;"
                   src="../../../assets/img/thematicData_jrzj1.png"/>
              <div>
            ...
            <el-col :span="7" class="head-right">
              <img style="float: left;width: 45px;height: 40px;margin-right:5px;"
                   src="../../../assets/img/thematicData.vue_jszj1.png"/>
              ...
              <el-row>
                <el-col :span="9">
                  ...
                  <span v-if="isContinue" style="color: #666666;">
                    <img class="thematicData-debug-pause-continue" @click="isContinue=false;"
                         src="../../../assets/img/pause.png"/>
                    暂停接收
                  </span>
                  <span v-else style="color: #666666;">
                    <img class="thematicData-debug-pause-continue" @click="isContinue=true;"
                ...
                <el-col :span="5" style="text-align: right;margin-right: 0px;" class="thematicData-debug-title">
                  ...
                  <span v-if="isIpLock">
                    <img class="thematicData-debug-pause-continue" @click="lockTheme('isIpLock1')"
                         src="../../../assets/img/lockup.png"/>
                    解锁主机
                  </span>
                  <span v-else>
                    <img class="thematicData-debug-pause-continue" @click="lockTheme('isIpLock0')"
                ...
                <el-col :span="5" style="text-align: right;margin-right: 0px;" class="thematicData-debug-title" v-if="form.object_type == '2'">
                  <span v-if="isYwLock">
                    <img class="thematicData-debug-pause-continue" @click="lockTheme('isYwLock1')"
                         src="../../../assets/img/lockup.png"/>
                    解锁业务
                  </span>
                  <span v-else>
                    <img class="thematicData-debug-pause-continue" @click="lockTheme('isYwLock0')"
                         src="../../../assets/img/unlock.png"/>
                    锁定业务
                  </span>

                  <div v-if="receiveBizCode" style="color: #B8CCD3;" class="thematicData-jszj-jrzj">{{receiveBizCode}}
                  </div>
                </el-col>

                <el-col :span="5" style="text-align: right;margin-right: 0px;padding-left: 3%;"
                        class="thematicData-debug-title">
                  <span v-if="isZbLock">
                    <img class="thematicData-debug-pause-continue" @click="lockTheme('isZbLock1')"
                         src="../../../assets/img/lockup.png"/>
                    解锁指标
                  </span>
                  <span v-else>
                    <img class="thematicData-debug-pause-continue" @click="lockTheme('isZbLock0')"
                         src="../../../assets/img/unlock.png"/>
                    锁定指标
                  </span>

                  <div v-if="receiveJkzbCode"
                       style="color:#B8CCD3;overflow:hidden;text-overflow: ellipsis;white-space:nowrap;"
                       class="thematicData-jszj-jrzj" :title="receiveJkzbCode">{{receiveJkzbCode}}
                  </div>
                </el-col>
              </el-row>
            </el-col>
    ...
    <el-dialog :visible.sync="addSuccessDialog" width="30%" :before-close="handleClose" class="dialogsuc">
      <div style="text-align:center">
        ...
        <div
          style="margin-top:20px;margin-bottom:35px;font-family: PingFangSC-Regular;font-size: 14px;color: #3B3A3F;line-height: 16px;">
          恭喜完成主题数据的接入
        </div>
      </div>
      <div style="text-align:center">
    ...
    data () {
      ...
      return {
        ...
        formRule: {
          ...
          // object_id: [
          //   {required: false, message: '请选择关联对象', trigger: 'change'}
          // ],
          object_type: [
