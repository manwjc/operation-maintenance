    ...
    <el-form label-width="200"
      ...
      <section class="btn-wrap">
        ...
        <el-button size="small"
                   @click="cancel('searchHead')">重置</el-button>
      </section>
    </el-form>
    ...
    <el-dialog class="yw-dialog"
      ...
      <section class="yw-dialog-main">
        <el-form class="yw-form"
          ...
          <el-form-item prop="clean.cleanDialogTextArea"
                        label="清除原因"
        ...
        <el-form class="yw-form"
          ...
          <el-form-item label="设备类型">
            <el-select v-model="search.device_type"
                       ...
                       clearable
                       filterable>
              <el-option v-for="item in device_types"
                         :key="item.value"
                         :label="item.name"
                         :value="item.value">
              </el-option>
  ...
  data () {
    return {
      ...
      checkColumns: [
        ...
        //   'keyName': '资源池',
        //   'keyIsSelected': true },
        { 'keyCode': 'alert_end_time', 'keyName': '自动解除时间', 'keyIsSelected': false },
  ...
  methods: {
    ...
    startInit () {
      ...
      if (this.$route.query.alertType === 'main') {
        this.search.operate_status = this.$route.query.operation_status
        this.alert_level_value = this.$route.query.alert_level.toString()
        obj = this.packInit()
      } else if (this.$route.query.alertType === 'his_detail') {
        obj = this.$route.query.requestData
        this.currentPage = obj.page_no
        this.pageSize = obj.page_size
        this.device_value = obj.deviceIp
        this.monitor_value = obj.monitItems
        this.alert_level_value = obj.alertLevel
        this.search.alert_date_from = obj.alertCreateTimeRangeStart
        this.search.alert_date_to = obj.alertCreateTimeRangeEnd
        this.search.alert_type = obj.objectType
        this.search.device_type = obj.deviceType
        this.search.device_class = obj.deviceClass
        this.search.system = obj.bizSys
        this.search.alert_description = obj.monitDesc
        this.search.resource_pool = obj.idcType
        this.search.device_room = obj.sourceRoom
        this.search.noticeType = obj.notifyType
        this.search.notice_status = obj.notifyStatus
        this.search.notice_date_from = obj.notifyTimeRangeStart
        this.search.notice_date_to = obj.notifyTimeRangeEnd
        this.search.confirm_date_from = obj.confirmTimeRangeStart
        this.search.confirm_date_to = obj.confirmTimeRangeEnd
        this.search.transferTimeRangeStart = obj.transfer_date_from
        this.search.transfer_date_to = obj.transferTimeRangeEnd
        this.search.work_date_from = obj.deliverTimeRangeStart
        this.search.work_date_to = obj.deliverTimeRangeEnd
        this.search.transfer_operator = obj.transferStaff
        this.search.confirm_operator = obj.toConfirmStaff
        this.search.work_operator = obj.deliver
        this.search.clean.isClean = obj.isClear
        this.search.clean.clean_time_from = obj.clearTimeRangeStart
        this.search.clean.clean_time_to = obj.clearTimeRangeEnd
        this.search.filter.isFilter = obj.isFiltered
        this.search.filter.filter_time_from = obj.filterTimeRangeStart
        this.search.filter.filter_time_to = obj.filterTimeRangeEnd
        this.search.project.isProject = obj.isProject
        this.search.project.project_time_from = obj.projectTimeRangeStart
        this.search.project.project_time_to = obj.projectTimeRangeEnd
        this.search.pattern.isPattern = obj.isMaintain
        this.search.pattern.pattern_time_from = obj.maintainTimeRangeStart
        this.search.pattern.pattern_time_to = obj.maintainTimeRangeEnd
        this.search.alert_from = obj.source
        this.search.device_mfrs = obj.deviceMfrs
        this.search.device_model = obj.deviceModel
        this.search.host_name = obj.hostName
      } else {
        obj = this.packInit()
      }
    ...
    resourceExport () {
      ...
      rbAlertKanBanServiceFactory.ExportGridData1(this.packInit()).then((res) => {
        if (res.code === '0000') {
...
/deep/ .yw-form .el-form-item__label {
  width: auto;
}
</style>
