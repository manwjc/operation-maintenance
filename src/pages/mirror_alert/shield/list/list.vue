  ...
  export default {
    ...
    methods: {
      ...
      delBatch() {
        ...
        rbAlertIsolateServiceFactory.delete(ids).then((data) => {
          this.query()
        })
      },
      del(id) {
        rbAlertIsolateServiceFactory.delete([id]).then((data) => {
          this.query()
        })
      },
      ...
      openBatch() {
        ...
        this.$confirm('确认启用?').then(() => {
          rbAlertIsolateServiceFactory.start(ids).then((data) => {
            this.query()
          })
        })
      },
      open(id) {
        this.$confirm('确认启用?').then(() => {
          rbAlertIsolateServiceFactory.start([id]).then((data) => {
            this.query()
          })
        })
      },
      ...
      closeBatch() {
        ...
        this.$confirm('确认停用?').then(() => {
          rbAlertIsolateServiceFactory.stop(ids).then((data) => {
            this.query()
          })
        })
      },
      close(id) {
        this.$confirm('确认停用?').then(() => {
          rbAlertIsolateServiceFactory.stop([id]).then((data) => {
            this.query()
          })
        })
      },
