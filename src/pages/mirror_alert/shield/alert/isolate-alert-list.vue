  ...
  <div class="components-container yw-dashboard">
    <el-form class="yw-form components-condition"
      ...
      <el-form-item label="屏蔽规则">
        <el-select v-model="formData.isolateId" clearable>
...
<script>
  ...
  export default {
    name: '/mirror_alert/shield/alert',
    mixins: [QueryObject],
    components: {
    ...
    methods: {
      ...
      setParams(activePagination) {
        ...
        if (activePagination) {
          ...
          this.queryParams = {
            'isolateTimeFrom': this.formData.effectiveDate && this.formData.effectiveDate[0],
            'isolateTimeTo': this.formData.effectiveDate && this.formData.effectiveDate[1],
            'isolateId': this.formData.isolateId,
      ...
      exportBatch() {
        ...
        rbAlertIsolateServiceFactory.exportIsolateAlertList(this.queryParams).then((res) => {
          ...
          downLoadElement.download = '告警屏蔽记录.xlsx'
