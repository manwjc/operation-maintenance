<template>
  <div class="components-container yw-dashboard">
    <el-form class="yw-form components-condition"
      ...
      <el-form-item label="衍生告警ID">
        <el-input v-model="formData.deriveAlertId"></el-input>
      </el-form-item>
    ...
    <el-form class="yw-form">
      ...
      <div class="yw-el-table-wrap">
        <el-table class="yw-el-table"
          ...
          <el-table-column label="衍生告警ID"
                           width="270">
            <template slot-scope="scope">
              {{scope.row.deriveAlertId}}
            </template>
          </el-table-column>
        </el-table>
      </div>
...
export default {
  name: '/mirror_alert/derive/alert',
  mixins: [QueryObject],
  components: {
  ...
  methods: {
    ...
    setParams (activePagination) {
      ...
      if (activePagination) {
        ...
        this.queryParams = {
          'deriveTimeFrom': this.formData.effectiveDate && this.formData.effectiveDate[0],
          'deriveTimeTo': this.formData.effectiveDate && this.formData.effectiveDate[1],
          'deriveId': this.formData.deriveId,
          'deriveAlertId': this.formData.deriveAlertId,
