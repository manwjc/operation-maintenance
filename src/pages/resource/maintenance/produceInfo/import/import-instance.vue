    ...
    <el-form ref="importPanel" label-position="top" class="demo-ruleForm" label-width="100px" style="padding-right:30px;" v-if="showImportPanel">
      <el-form-item align="center">
        <el-upload
          ...
          :headers="headers"
          drag
          :action="'/v1/cmdb/process/import?importType=' + importType" :on-success="handleSuccess"
          multiple>
    ...
    methods: {
      ...
      downloadTemplete () {
        ...
        this.rbHttp.sendRequest({
          ...
          downLoadElement.download = '维保厂商导入模板.xlsx'
        ...
        rbCmdbServiceFactory.getImportProcess(proccessId).then((data) => {
          if (data.flag === 'true') {
            ...
            if (data.data.endTime) {
              ...
              // _t.showErrorDown = data.data.errorList.length > 0
