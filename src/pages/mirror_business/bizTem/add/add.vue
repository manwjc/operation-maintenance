      ...
      <div v-show="active == 0 ? true:false"
        ...
        <el-form class="yw-form is-required form-step"
          ...
          <el-form-item prop="object_ids"
            ...
            <el-input v-model="newTemplate.object_ids"
                      placeholder="请选择设备"
                      class="add-con moreCon"
                      disabled
                      :title="newTemplate.object_ids"></el-input>
            <el-button class="mirror_but"
                       type="primary"
                       @click="goDevices()"
                       style="position: absolute;left: 215px;top: 5px;">设备管理</el-button>
          </el-form-item>
...
export default {
  name: '/mirror_business/bizTem/add',
  data () {
